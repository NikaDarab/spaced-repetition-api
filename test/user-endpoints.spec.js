    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "settimana", translation: "week" },
            { original: "anno", translation: "year" },
            { original: "oggi", translation: "today" },
            { original: "domani", translation: "tomorrow" },
            { original: "ieri", translation: "yesterday" },
            { original: "calendario", translation: "calendar" },
            { original: "secondo", translation: "second" },
            { original: "ora", translation: "hour" },
          ],
        };
        return supertest(app)
          .post("/api/user")
